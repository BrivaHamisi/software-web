            ...
            <div class="relative w-full max-w-7xl mx-auto px-6 lg:px-8">
                <div class="flex items-center justify-between py-4 lg:py-6">
                    ...
                    <div class="flex items-center space-x-4 group">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-[#FF2D20] group-hover:scale-110 transition-transform duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                        </svg>
                        <span class="text-2xl font-bold text-gray-800 group-hover:text-[#FF2D20] transition-colors">YourBrand</span>
                    </div>
        
                    <!-- Navigation Menu -->
                    <nav class="hidden md:flex items-center space-x-6">
                        <a href="{{ url('/') }}" class="relative group text-gray-700 hover:text-[#FF2D20] transition-colors font-medium 
                        ...
                        <a href="#" class="relative group text-gray-700 hover:text-[#FF2D20] transition-colors font-medium 
                            before:absolute before:-bottom-2 before:left-0 before:w-0 before:h-0.5 before:bg-[#FF2D20] 
                            before:transition-all before:duration-300 
                            hover:before:w-full">
                            Blogs
                        ...
                        @if (Route::has('login'))
                            @auth
                                <a href="{{ url('/dashboard') }}" class="rounded-md px-4 py-2 bg-[#FF2D20]/10 text-[#FF2D20] 
                                    hover:bg-[#FF2D20]/20 transition-colors transform hover:scale-105 active:scale-95">
                                    Dashboard
                                </a>
                            @else
                                <div class="flex items-center space-x-4">
                                    <a href="{{ route('login') }}" class="relative group text-gray-700 hover:text-[#FF2D20] 
                                    ...
                                    @if (Route::has('register'))
                                        <a href="{{ route('register') }}" class="rounded-md px-4 py-2 bg-[#FF2D20] text-white 
                    ...
                    <div class="md:hidden">
                        <button id="mobile-menu-toggle" class="text-gray-700 hover:text-[#FF2D20] focus:outline-none 
                ...
                <div id="mobile-menu" class="md:hidden absolute top-full left-0 w-full bg-white/95 backdrop-blur-md shadow-lg hidden">
                    <div class="px-6 py-4 space-y-4">
                        <a href="{{ url('/') }}" class="block text-gray-700 hover:text-[#FF2D20] transition-colors font-medium 
                            {{ request()->is('/') ? 'text-[#FF2D20] font-semibold' : '' }}">
                            Home
                        </a>
                        <a href="#" class="block text-gray-700 hover:text-[#FF2D20] transition-colors font-medium">
                            Blogs
                        </a>
                        
                        @if (Route::has('login'))
                            @auth
                                <a href="{{ url('/dashboard') }}" class="block w-full rounded-md px-4 py-2 bg-[#FF2D20]/10 
                                    text-[#FF2D20] hover:bg-[#FF2D20]/20 text-center transition-colors">
                                    Dashboard
                                </a>
                            @else
                                <div class="space-y-4">
                                    <a href="{{ route('login') }}" class="block w-full text-center text-gray-700 
                                        hover:text-[#FF2D20] transition-colors font-medium">
                                        Log in
                                    </a>
        
                                    @if (Route::has('register'))
                                        <a href="{{ route('register') }}" class="block w-full rounded-md px-4 py-2 
...
<div class="relative min-h-screen flex flex-col items-center justify-center pt-12 overflow-hidden">
    ...
    <div class="absolute inset-0 pointer-events-none">
        ...
        <div class="absolute bottom-0 left-0 w-96 h-96 bg-[#FF2D20]/10 rounded-full blur-3xl animate-blob animation-delay-4000"></div>
    </div>
        ...
        <div class="flex flex-col items-center justify-center text-center max-w-3xl mx-auto mt-12 space-y-6">
            <div class="relative">
                <h1 class="text-5xl font-bold mb-4 text-gray-900 leading-tight relative">
                    ...
                    <div class="absolute -top-2 -right-2 w-12 h-12 bg-[#FF2D20]/20 rounded-full animate-ping"></div>
                </h1>
            </div>
            ...
            <div class="flex flex-wrap justify-center space-x-2 sm:space-x-4 opacity-0 animate-fadeIn animation-delay-1000">
                <button class="bg-[#FF2D20] text-white px-4 py-2 sm:px-8 sm:py-3 rounded-full hover:bg-[#e02717] transition-all shadow-md hover:shadow-lg transform hover:-translate-y-1 group text-sm sm:text-base">
                    Get Started
                    <span class="inline-block ml-1 sm:ml-2 group-hover:translate-x-1 transition-transform">→</span>
                </button>
                <button class="border border-gray-300 text-gray-700 px-4 py-2 sm:px-8 sm:py-3 rounded-full hover:bg-gray-100 transition-all transform hover:-translate-y-1 text-sm sm:text-base">
                    Learn More
                </button>
            </div>
        </div>
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div>
                    ...
                    <p class="text-gray-600 text-lg mb-6 leading-relaxed">
                        Founded in 2010, YourBrand has been at the forefront of innovative software solutions. Our mission is to empower businesses through cutting-edge technology that transforms operations, enhances productivity, and drives sustainable growth.
                    </p>
                ...
                <div class="relative">
                    ...
                    <img 
                        src="/images/Office_600_400.png" 
                        alt="YourBrand Office" 
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        <div class="text-center mb-12">
            ...
            <p class="text-gray-600 max-w-2xl mx-auto">
                Powerful, innovative solutions designed to drive your business forward. Explore our comprehensive suite of cutting-edge products.
            </p>
        </div>
        <div class="grid md:grid-cols-4 gap-8">
            <div class="bg-gray-50 p-6 rounded-xl hover:shadow-md transition-all group">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-[#FF2D20] mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z" />
                </svg>
                <h3 class="text-xl font-bold mb-3 text-gray-900">Business Suite</h3>
                <p class="text-gray-600 mb-4">Comprehensive software solution for seamless business management and collaboration.</p>
            ...
            <div class="bg-gray-50 p-6 rounded-xl hover:shadow-md transition-all group">
                ...
                <p class="text-gray-600 mb-4">Scalable enterprise-grade solutions tailored to meet complex organizational needs.</p>
                <a href="#" class="text-[#FF2D20] hover:underline group-hover:ml-2 transition-all">
                    Learn More →
                </a>
            </div>
            <div class="bg-gray-50 p-6 rounded-xl hover:shadow-md transition-all group">
                ...
                <p class="text-gray-600 mb-4">Advanced data analytics tools to transform raw data into actionable business insights.</p>
                <a href="#" class="text-[#FF2D20] hover:underline group-hover:ml-2 transition-all">
                    Learn More →
                </a>
            </div>
            <div class="bg-gray-50 p-6 rounded-xl hover:shadow-md transition-all group">
                ...
                <p class="text-gray-600 mb-4">Secure, scalable cloud infrastructure and hosting solutions for modern businesses.</p>
                <a href="#" class="text-[#FF2D20] hover:underline group-hover:ml-2 transition-all">
                    Learn More →
                </a>
            </div>
    ...
    <div id="careers" class="py-24 bg-white">
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="text-center mb-12">
                ...
                <p class="text-gray-600 max-w-2xl mx-auto">
                    We're always looking for talented, passionate individuals who want to make a difference. At YourBrand, we offer more than just a job – we provide a platform for growth, innovation, and personal development.
                </p>
            </div>
    ...
    <div id="press" class="py-24 bg-gradient-to-br from-gray-50 to-gray-100">
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="text-center mb-12">
                <div class="bg-[#FF2D20]/10 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-[#FF2D20]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2V3L3 7l2 4V5h10v14H5" />
                    </svg>
                </div>
                <h2 class="text-4xl font-bold text-gray-900 mb-4">In the News</h2>
                <p class="text-gray-600 max-w-2xl mx-auto">
                    YourBrand continues to make waves in the tech industry. Check out our latest press coverage and media mentions.
                </p>
            </div>
            <div class="grid md:grid-cols-3 gap-8">
        ...
        <div class="grid md:grid-cols-2 gap-12 items-center">
            <div>
                ...
                <p class="text-gray-600 text-lg mb-8">
                    Have a question or want to discuss how YourBrand can transform your business? Reach out to our team, and we'll get back to you as soon as possible.
                </p>
                <div class="space-y-6">
                    <div class="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-[#FF2D20] mr-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <form class="bg-gray-50 p-8 rounded-xl shadow-md">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" id="name" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#FF2D20]/50" placeholder="Your Name" required>
                        </div>
                        <div>
                            <label class="block text-gray-700 mb-2" for="email">Email Address</label>
                            <input type="email" id="email" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#FF2D20]/50" placeholder="you@example.com" required>
                        </div>
                        <div>
                            <label class="block text-gray-700 mb-2" for="message">Your Message</label>
                            <textarea id="message" rows="4" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#FF2D20]/50" placeholder="How can we help you?" required></textarea>
                        </div>
                        <button type="submit" class="w-full bg-[#FF2D20] text-white py-3 rounded-lg hover:bg-[#FF2D20]/90 transition-colors">
                            Send Message
                        </button>
                    </div>
                </form>
            ...
            <div class="max-w-7xl mx-auto px-6 lg:px-8">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-12">
                    ...
                    <div>
                        ...
                        <ul class="space-y-4">
                            <li><a href="#" class="text-gray-400 hover:text-white transition-colors">Business Suite</a></li>
                            <li><a href="#" class="text-gray-400 hover:text-white transition-colors">Enterprise Solutions</a></li>
                            <li><a href="#" class="text-gray-400 hover:text-white transition-colors">Analytics Platform</a></li>
                            <li><a href="#" class="text-gray-400 hover:text-white transition-colors">Cloud Services</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex">
                            ...
                            />
                            <button class="bg-[#FF2D20] text-white px-4 py-2 rounded-r-md hover:bg-[#e02717] transition-colors">
                                Subscribe
                            </button>
                        </div>
                    </div>
